...
public class ProductDAO {
	...
	private final static String DELETE = "DELET FROM JSP_PRODUCT WHERE NUM = ?";
	...
	private final static String SELECTALL_ALL = "SELECT NUM, NAME, DETAILS, PRICE, CNT, SELLER FROM JSP_PRODUCT ORDER BY NUM";
	private final static String SELECTALL_NAME = "SELECT NUM, NAME, DETAILS, PRICE, CNT, SELLER FROM JSP_PRODUCT WHERE NAME LIKE '%'|| ? ||'%'";
	private final static String SELECTALL_SELLER = "SELECT NUM, NAME, DETAILS, PRICE, CNT, SELLER FROM JSP_PRODUCT WHERE SELLER LIKE '%'|| ? ||'%'";
